                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span12" style="padding: 1%">
                                        ...
                                        <div class="span2">
                                            <label for="dataInicial">Data da Comanda<span class="required">*</span></label>
                                            <input id="dataVenda" class="span12 datepicker" type="text" name="dataVenda" value="<?php echo date('d/m/Y'); ?>"  />
                                        </div>
                                        
                                        <div class="span5">
                                            <label for="nome">Nome da Comanda<span class="required">*</span></label>
                                            <input id="descricao" class="span12" type="text" name="descricao" value=""  />
                                        </div>
...
$(document).ready(function(){
      ...
      $("#tecnico").autocomplete({
            source: "<?php echo base_url(); ?>index.php/comandas/autoCompleteUsuario",
            minLength: 1,
            select: function( event, ui ) {
