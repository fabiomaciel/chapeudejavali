            ...
            <div class="widget-content nopadding">
                ...
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li class="active" id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalhes da Comanda</a></li>
                            ...
                            <div class="span12" id="divEditarVenda">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <h3>#Comanda: <?php echo $result->idVendas ?></h3>
                                        ...
                                        <div class="span5" >
                                            <label for="descricao">Nomde da Comanda<span class="required">*</span></label>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span8 offset2" style="text-align: center">
                                            ...
                                            <a href="<?php echo base_url() ?>index.php/comandas/visualizar/<?php echo $result->idVendas; ?>" class="btn btn-inverse"><i class="icon-eye-open"></i> Visualizar Comanda</a>
...
<div class="modal-header">
  ...
  <h3 id="myModalLabel">Faturar Comanda</h3>
</div>
<div class="modal-body">
    ...
    <div class="span12" style="margin-left: 0"> 
      ...
      <div id="divRecebimento" class="span8" >
        <div class="span6">
...
$(document).ready(function(){
            ...
            $.ajax({
              ...
              success: function(data)
              {
                if(data.result == true){    
                    ...
                    alert('Ocorreu um erro ao tentar faturar comanda.');
     ...
     $("#produto").autocomplete({
            source: "<?php echo base_url(); ?>index.php/comandas/autoCompleteProduto",
            minLength: 2,
      ...
      $("#cliente").autocomplete({
            source: "<?php echo base_url(); ?>index.php/comandas/autoCompleteCliente",
            minLength: 2,
            select: function( event, ui ) {
