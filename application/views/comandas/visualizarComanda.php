                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 18%; text-align: center">#Comanda: <span ><?php echo $result->idVendas?></span></br> </br> <span>Emissão: <?php echo date('d/m/Y');?></span></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="width: 50%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span><h5>Comanda</h5>
                                                <span><h4><?php echo $result->descricao?></h4></span><br/>
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
