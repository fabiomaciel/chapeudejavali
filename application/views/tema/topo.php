...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i> Menu</a>
  <ul>
    ...
    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vComanda')){ ?>
        <li class="<?php if(isset($menuComandas)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/comandas"><i class="icon icon-glass"></i> <span>Comandas</span></a></li>
    <?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> <a href="/" ><?php echo date('Y'); ?> &copy; RB GARAGE OS - Kymera </a></div>
</div>
<!--end-Footer-part-->
